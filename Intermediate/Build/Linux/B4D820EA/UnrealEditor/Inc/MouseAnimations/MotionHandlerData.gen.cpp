...
template<> MOUSEANIMATIONS_API UScriptStruct* StaticStruct<FMotionHandlerData>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMotionHandlerData_Statics::NewProp_CurrentIndex_MetaData[] = {
		{ "ModuleRelativePath", "Private/MotionHandlerData.h" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMotionHandlerData_Statics::NewProp_CurrentIndex = { "CurrentIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMotionHandlerData, CurrentIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FMotionHandlerData_Statics::NewProp_CurrentIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMotionHandlerData_Statics::NewProp_CurrentIndex_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_AllOfTheLights503_Plugins_MouseAnimations_Source_MouseAnimations_Private_MotionHandlerData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_AllOfTheLights503_Plugins_MouseAnimations_Source_MouseAnimations_Private_MotionHandlerData_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_AllOfTheLights503_Plugins_MouseAnimations_Source_MouseAnimations_Private_MotionHandlerData_h_1587852850(TEXT("/Script/MouseAnimations"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_AllOfTheLights503_Plugins_MouseAnimations_Source_MouseAnimations_Private_MotionHandlerData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_AllOfTheLights503_Plugins_MouseAnimations_Source_MouseAnimations_Private_MotionHandlerData_h_Statics::ScriptStructInfo),
		nullptr, 0);
